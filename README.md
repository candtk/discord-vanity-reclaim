...
## Basic Usage
1) Build the program from source or download a pre-built version for your OS & Arch from [releases](https://github.com/candtk/discord-vanity-reclaim/releases)
