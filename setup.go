...
func SetupReclaimer() {
	...
	LogInfo(fmt.Sprintf("initiated with %d proxies and %d vanities", len(ProxyList), len(VanityList)))
	LogInfo("ensure you have enough proxies or this tool will not work")
	UserInput("enter any key to start")
